...
/**
 * AnnotatingGraphMousePlugin can create Shape and Text annotations in a layer
 ...
 */
public class AnnotatingGraphMousePlugin<V, E> extends
	 ...
	 */
	protected AnnotationManager<V, E> annotationManager;
	...
	/**
	 * set to true when the AnnotationPaintable has been added to the view
	 * component
	 */
	...
	public AnnotatingGraphMousePlugin(RenderContext<V, E> rc) {
		this(rc, InputEvent.BUTTON1_MASK, InputEvent.BUTTON1_MASK
	...
	public AnnotatingGraphMousePlugin(RenderContext<V, E> rc,
		...
		this.annotationManager = new AnnotationManager<V, E>(rc);
	...
	/**
	 * the Paintable that draws a Shape annotation only while it is being
	 * created
	 * 
	 */
	...
	/**
	 * Sets the location for an Annotation. Will either pop up a dialog to
	 * prompt for text input for a text annotation, or begin the process of
	...
	public void mousePressed(MouseEvent e) {
		...
		if (added == false) {
			vv.addPreRenderPaintable(annotationManager
					.getLowerAnnotationPaintable());
			vv.addPostRenderPaintable(annotationManager
					.getUpperAnnotationPaintable());
			added = true;
		}

		// CARL - removed this functionality to assign an arbitrary String
		// annotation to any location
		// if (e.isPopupTrigger()) {
		// String annotationString = JOptionPane.showInputDialog(vv,
		// "Annotation:");
		...
		// Annotation<String, Integer> annotation = new Annotation<String,
		// Integer>(
		// annotationString, layer, annotationColor, fill, p, null);
	...
	/**
	 * Completes the process of adding a Shape annotation and removed the
	 * transient paintable
	 * 
	 */
	@SuppressWarnings("unchecked")
	public void mouseReleased(MouseEvent e) {
		...
		// Annotation<Shape, Integer> annotation = new Annotation<Shape,
		// Integer>(
		// s, layer, annotationColor, fill, out, null);
		// annotationManager.add(layer, annotation);
		// }
		// }
		down = null;
	...
	/**
	 * Draws the transient Paintable that will become a Shape annotation when
