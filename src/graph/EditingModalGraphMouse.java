...
/**
 * 
 * CARL - This class has been repackaged to override the types of the
 * editingPlugin, popupEditingPlugin and annotatingPlugin
 * 
 * 
...
public class EditingModalGraphMouse<V, E> extends AbstractModalGraphMouse
	...
	public EditingModalGraphMouse(RenderContext<V, E> rc,
			Factory<V> vertexFactory, Factory<E> edgeFactory,JFrame parentFrame,AttributeMap attributeMap,SparseMultigraph<V,E> graph,HashMap<EdgeStatementMap,String> edgeLabelMap) {
		this(rc, vertexFactory, edgeFactory, 1.1f, 1 / 1.1f,parentFrame,attributeMap,graph,edgeLabelMap);
	}
	 ...
	 */
	public EditingModalGraphMouse(RenderContext<V, E> rc,
			Factory<V> vertexFactory, Factory<E> edgeFactory, float in,
			float out,JFrame parentFrame,AttributeMap attributeMap,SparseMultigraph<V,E> graph,HashMap<EdgeStatementMap,String> edgeLabelMap) {
		super(in, out);
	...
	protected void loadPlugins() {
		...
		popupEditingPlugin = new AttributeEditingPopupPlugin<V, E>(
